class CustomerController < ApplicationController
  ...
  def customer_params
    params.require(:user).permit(:email, :password, :password_confirmation, :is_active, :primary_phone_no, 
      ...
      family_attributes: [{personal_info_attributes: [personal_info_attributes: [:first_name, :middle_name, :last_name, :date_of_birth, :gender]]}, :health, :death_age, :death_year, :death_reason],
